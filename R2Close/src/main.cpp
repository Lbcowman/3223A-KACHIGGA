...
// Functions
  ...
  int Print(){
    while (1) {
      ...
      Brain.Screen.newLine();
      Brain.Screen.print("Triball level: ");
      Brain.Screen.print((HighIntakeDist.objectDistance(mm)));
...
void autonomous(void) { 
  ...
  intakeMode = "cata";
    PositionDegrees = -170; //Drive Distance CM
    DriveSpeedPCT = 100; //Drive Speed %
  Turn("Abs");
...
wait(50, msec);
  ...
  Turn("Abs");
    ...
    DriveDistanceIN = -35; //Drive Distance CM
    DriveSpeedPCT = 100; //Drive Speed %
    TimeOutsec=.7; 
  straight();
  ...
  straight();
      ...
      PositionDegrees = -92; //Drive Distance CM
  ...
  straight();
   ...
   PositionDegrees = 115; //Drive Distance CM
    DriveSpeedPCT = 22; //Drive Speed %
  Turn("Abs");


    DriveDistanceIN = 18; //Drive Distance CM
    DriveSpeedPCT = 100; //Drive Speed %
    TimeOutsec=3; 
  straight();
